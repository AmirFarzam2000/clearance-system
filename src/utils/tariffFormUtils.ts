...
export const buildPayload = (
  ...
  // Only include second counting unit if provided
  if (data.countingUnit2) {
    payload.SecondCountingUnitID = parseInt(data.countingUnit2);
    payload.SecondCountingUnitTitle = getCountingUnitTitle(data.countingUnit2);
  }

  // Only include third counting unit if provided
  if (data.countingUnit3) {
    payload.ThirdCountingUnitID = parseInt(data.countingUnit3);
    payload.ThirdCountingUnitTitle = getCountingUnitTitle(data.countingUnit3);
  }
